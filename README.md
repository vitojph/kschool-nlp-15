...
This repo contains the NLP materials for the 15th edition of the [Data Science
...
- [`word2vec` word Embeddings](notebooks/word2vec.ipynb)
- [`fastText` word Embeddings](notebooks/fastText.ipynb)
